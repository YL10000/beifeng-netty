package com.beifeng.hadoop.netty.fixed;
...
public class TimerServerHandler extends ChannelHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext context, Object msg) throws Exception {
        ...
        /*String currentTime=NettyUtils.SEND_MESSAGE.equalsIgnoreCase(body)?new Date().toString():NettyUtils.BAD_MESSAGE;
        currentTime+=NettyUtils.DELIMTER_SEPARATOR;
